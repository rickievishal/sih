...
export default function Home() {
  ...
  useEffect(() => { 
    // Function to fetch data from the Express server using Axios
    
    const fetchData = async () => {
      try {
        const response = await axios.get("http://172.16.8.231:3000/data");
  ...
  return (
    <>
      {/* <div className="App w-full h-full flex  justify-center items-center">
        ...
        <div className=" max-w-3xl mx-auto text-black h-screen flex flex-col relative ">
        <div className="max-w-lg h-[50px] text-gray-400 px-4 rounded-xl mb-3  bg-[rgba(97,97,97,0.36)] backdrop-blur-sm border border-[rgb(66,66,66)] fixed bottom-[50px] right-1/2 translate-x-1/2  flex justify-center items-center gap-5">
          ...
          <nav className="w-full absolute top-0 right-0 flex justify-between mx-auto items-end px-3 py-5">
          ...
          <div className="flex flex-col justify-center items-center px-3 pt-[130px] ">
            ...
            <div className=" w-full flex justify-center items-center gap-x-2">
              <div className="w-full flex flex-col justify-center items-start  rounded-3xl  bg-[#E8647C] px-10 py-5 mt-3">
                <h3 className="text-2xl w-full justify-start font-semibold text-white">Stress</h3>
              ...
              <div className="w-full flex flex-col justify-center items-start  rounded-3xl  bg-[#FC6B3F] px-10  py-5 mt-3">
